...
export function NewNoteCard({ onNoteCreate }: NewNoteCardProps) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md flex flex-col bg-stone-700 text-left p-5 gap-3 outline-none hover:ring-2 hover:ring-stone-600 focus-visible:ring-2 focus-visible:ring-lime-400">
        <span className="text-small font-medium text-stone-200">
          Adicionar nota
        </span>
          ...
          <form onSubmit={handleSaveNote} className="flex-1 flex flex-col">
            <div className="flex flex-1 flex-col gap-3 p-5">
              ...
              {shouldShowOnBoarding ? (
                ...
                <textarea
                  autoFocus
                  className="text-small leading-6 text-stone-400 bg-transparent resize-none flex-1 outline-none"
            ...
            {isRecording ? (
              <button
                ...
                type="button"
                className="w-full flex items-center justify-center gap-2 animate-pulse bg-stone-900 py-4 text-center text-sm text-stone-300 outline-none font-bold "
              >
